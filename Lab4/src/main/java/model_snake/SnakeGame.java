...
public class SnakeGame {
	...
	public SnakeGame(SnakesProto.GameConfig gameConfig, GameWindow gameWindow, SnakesProto.NodeRole nodeRole) {
		this.gameConfig = gameConfig;
		this.gameWindow = gameWindow;
		this.messageManager = new MessageManager(this, gameConfig, nodeRole);
