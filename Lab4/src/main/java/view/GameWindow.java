...
import model_snake.Point;
import model_snake.Snake;
import model_snake.SnakeGame;
...
public class GameWindow {
	...
	private final Color foodColor = Color.rgb(255, 255, 0);
	private final Color enemyBodyColor = Color.rgb(255, 0, 0);
	private final Color enemyHeadColor = Color.rgb(255, 95, 168);
	private final Color myBodyColor = Color.rgb(46, 84, 204);
	private final Color myHeadColor = Color.rgb(24, 151, 204);
