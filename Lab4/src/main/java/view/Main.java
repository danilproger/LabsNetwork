...
public class Main extends Application {
	...
	private final ConcurrentHashMap<HostInfo, SnakesProto.GameMessage.AnnouncementMsg> sessionInfoMap = new ConcurrentHashMap<>();
	...
	public void start(Stage stage) {
		...
		stage.setOnCloseRequest(actionEvent -> discoverer.interrupt());
	...
	private TableView<SessionInfo> createTableViewColumns() {
		...
		tableView.getColumns().addAll(
				...
				heightColumn,
				baseFoodColumn,
				foodMultiplyerColumn,
				foodDropChanceColumn,
				numOfPlayersColumn,
				canJoinColumn
		);
